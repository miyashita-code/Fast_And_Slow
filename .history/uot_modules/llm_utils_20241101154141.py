...
# Define the models
＃gpt_4o_model = ChatOpenAI(model="gpt-4o", max_tokens=4096, temperature=0.0)
fireworks_llama70b = ChatFireworks(
    model="accounts/fireworks/models/llama-v3p2-90b-vision-instruct", 
    max_tokens=4096,
    temperature=0.0
)
claude_3_haiku_model = ChatAnthropic(
    model="claude-3-haiku-20240307", 
    max_tokens=4096,
    temperature=0.0
)
claude_3_5_sonnet_model = ChatAnthropic(
    model="claude-3-5-sonnet-20241022", 
    max_tokens=4096,
    temperature=0.0
)
fireworks_llama_v3p2_11b = ChatFireworks(
    model="accounts/fireworks/models/llama-v3p2-11b-vision-instruct", 
    max_tokens=4096,
    temperature=0.0
)
groq_llama_v3p2_90b = ChatGroq(
...
def get_response_util(usecase_name : str) -> RunnableSequence:
    ...
    if usecase_name == "evaluate_probabilities_of_chunk":
        ...
        return prompt_template_generate_questions | quasi_model | output_parser_generate_questions
    elif usecase_name == "generate_questions_fast":
        return prompt_template_generate_questions | fast_quasi_model | output_parser_generate_questions
